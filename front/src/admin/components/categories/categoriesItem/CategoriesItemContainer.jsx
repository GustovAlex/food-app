...
import {deleteCategory, updateCategory, addCategoryImg} from '../../../redux/actions/category'
...
export default function CategoriesItemContainer ({category}) {
	...
	const [categoryName, setCategoryName] = useState(!!targetCategoryName ? targetCategoryName : '')
	...
	const onClickDeleteCategory = () => dispatch(deleteCategory(categoryId))
