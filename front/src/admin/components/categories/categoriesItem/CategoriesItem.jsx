	...
	return (
		<div>
			<div className={classes.categoriesItemContent}>
				{!!category.img ? 
				<img className={classes.categoriesItemImg} src={`/categoriesImg/${category.img}`} alt="burger" /> 
				: <p className={classes.categoriesNoPhoto}>no photo</p>
				}
				<p className={classes.categoriesItemName}>{category.name}</p>
				<p className={classes.categoriesItemName}>{category.product.length }{category.product.length === 1 ? " product in category" : " products in category"} </p>
			...
			<ConfirmModal openConfirmModal={openConfirmModal}
